  ...
  return (
    <div className="min-h-screen bg-[#070809] text-[#F5F5F5] font-sans">
      ...
      <div className="mx-auto flex max-w-[1600px]">
        ...
        <aside className="hidden w-72 shrink-0 border-l border-[#24272a] p-5 xl:block" aria-label="Informações da comunidade"><div className="sticky top-24 space-y-4"><section className="rounded-lg border border-[#24272a] bg-[#0d0f10] p-4"><p className="text-[10px] font-mono uppercase tracking-[0.2em] text-[#E00000]">Em destaque</p><h2 className="mt-3 text-base font-semibold text-white">Segurança digital em comunidade</h2><p className="mt-2 text-sm leading-6 text-[#A1A1AA]">Compartilhe evidências, aprenda com outros membros e ajude a reduzir golpes.</p><button type="button" onClick={() => go('/forum/rules')} className="mt-4 text-xs font-semibold text-[#FF5A5A] hover:underline">Ler regras</button></section><section className="rounded-lg border border-[#24272a] bg-[#0d0f10] p-4"><p className="text-[10px] font-mono uppercase tracking-[0.2em] text-[#71757a]">Acesso rápido</p><div className="mt-3 space-y-2"><button type="button" onClick={() => go('/forum/create')} className="flex w-full items-center justify-between rounded px-2 py-2 text-left text-sm text-[#d5d7da] hover:bg-[#17191b]">Criar publicação <span className="text-[#E00000]">+</span></button><button type="button" onClick={() => go('/forum/communities')} className="flex w-full items-center justify-between rounded px-2 py-2 text-left text-sm text-[#d5d7da] hover:bg-[#17191b]">Explorar comunidades <span className="text-[#E00000]">→</span></button></div></section></div></aside>
      </div>
    </div>
  );
};
